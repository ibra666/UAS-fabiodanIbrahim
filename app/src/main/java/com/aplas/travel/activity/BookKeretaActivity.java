package com.aplas.travel.activity;
...
import com.aplas.travel.R;
import com.aplas.travel.database.DatabaseHelper;
import com.aplas.travel.session.SessionManager;
...
public class BookKeretaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String[] asal = {"malang", "surabaya", "Pasuruan", "banyuwangi", "bali"};
        final String[] tujuan = {"malang", "surabaya", "Pasuruan", "banyuwangi", "bali"};
        ...
        btnBook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (sAsal != null && sTujuan != null && sTanggal != null && sDewasa != null) {
                    if ((sAsal.equalsIgnoreCase("malang") && sTujuan.equalsIgnoreCase("malang"))
                            || (sAsal.equalsIgnoreCase("surabaya") && sTujuan.equalsIgnoreCase("surabaya"))
                            || (sAsal.equalsIgnoreCase("pasuruan") && sTujuan.equalsIgnoreCase("pasuruan"))
                            || (sAsal.equalsIgnoreCase("banyuwangi") && sTujuan.equalsIgnoreCase("banyuwangi"))
    ...
    public void perhitunganHarga() {
        if (sAsal.equalsIgnoreCase("malang") && sTujuan.equalsIgnoreCase("surabaya")) {
            hargaDewasa = 100000;
            hargaAnak = 70000;
        } else if (sAsal.equalsIgnoreCase("malang") && sTujuan.equalsIgnoreCase("pasuruan")) {
            hargaDewasa = 200000;
            hargaAnak = 150000;
        } else if (sAsal.equalsIgnoreCase("malang") && sTujuan.equalsIgnoreCase("banyuwangi")) {
            hargaDewasa = 150000;
            hargaAnak = 120000;
        } else if (sAsal.equalsIgnoreCase("malang") && sTujuan.equalsIgnoreCase("bali")) {
            hargaDewasa = 180000;
            hargaAnak = 140000;

        } else if (sAsal.equalsIgnoreCase("surabaya") && sTujuan.equalsIgnoreCase("malang")) {
            hargaDewasa = 100000;
            hargaAnak = 70000;
        } else if (sAsal.equalsIgnoreCase("surabaya") && sTujuan.equalsIgnoreCase("pasuruan")) {
            hargaDewasa = 120000;
            hargaAnak = 100000;
        } else if (sAsal.equalsIgnoreCase("surabaya") && sTujuan.equalsIgnoreCase("banyuwangi")) {
            hargaDewasa = 120000;
            hargaAnak = 90000;
        ...
        } else if (sAsal.equalsIgnoreCase("pasuruan") && sTujuan.equalsIgnoreCase("malang")) {
            hargaDewasa = 200000;
            hargaAnak = 150000;
        } else if (sAsal.equalsIgnoreCase("pasuruan") && sTujuan.equalsIgnoreCase("surabaya")) {
            hargaDewasa = 120000;
            hargaAnak = 100000;
        } else if (sAsal.equalsIgnoreCase("pasuruan") && sTujuan.equalsIgnoreCase("banyuwangi")) {
            hargaDewasa = 170000;
            hargaAnak = 130000;
        } else if (sAsal.equalsIgnoreCase("pasuruan") && sTujuan.equalsIgnoreCase("bali")) {
            hargaDewasa = 180000;
            hargaAnak = 150000;

        } else if (sAsal.equalsIgnoreCase("banyuwangi") && sTujuan.equalsIgnoreCase("malang")) {
            hargaDewasa = 150000;
            hargaAnak = 120000;
        } else if (sAsal.equalsIgnoreCase("banyuwangi") && sTujuan.equalsIgnoreCase("surabaya")) {
            hargaDewasa = 120000;
            hargaAnak = 90000;
        } else if (sAsal.equalsIgnoreCase("banyuwangi") && sTujuan.equalsIgnoreCase("pasuruan")) {
            hargaDewasa = 80000;
            hargaAnak = 40000;
        } else if (sAsal.equalsIgnoreCase("banyuwangi") && sTujuan.equalsIgnoreCase("bali")) {
            hargaDewasa = 170000;
            hargaAnak = 130000;

        } else if (sAsal.equalsIgnoreCase("bali") && sTujuan.equalsIgnoreCase("malang")) {
            hargaDewasa = 180000;
            hargaAnak = 140000;
        } else if (sAsal.equalsIgnoreCase("bali") && sTujuan.equalsIgnoreCase("surabaya")) {
            hargaDewasa = 190000;
            hargaAnak = 160000;
        } else if (sAsal.equalsIgnoreCase("bali") && sTujuan.equalsIgnoreCase("pasuruan")) {
            hargaDewasa = 80000;
            hargaAnak = 40000;
        } else if (sAsal.equalsIgnoreCase("bali") && sTujuan.equalsIgnoreCase("banyuwangi")) {
            hargaDewasa = 180000;
            hargaAnak = 150000;
        }
